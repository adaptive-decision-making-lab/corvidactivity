...
\hypersetup{
  ...
  pdflang={en-EN},
  pdfkeywords={activity levels, corvid, pair housing, stereotypies},
  hidelinks,
...
{\centering \subfloat[\label{fig:cage-fig-1}]{\includegraphics[width=0.7\linewidth]{figures/indiv_housed_pic} }\newline\subfloat[\label{fig:cage-fig-2}]{\includegraphics[width=0.7\linewidth]{figures/pair_housed_pic} }\newline
