...
\textbf{This preprint has been accepted for publication at \emph{Animal Welfare}. }
...
{\centering \subfloat[\label{fig:cage-fig-1}]{\includegraphics[width=0.85\linewidth]{figures/indiv_housed_pic} }\newline\subfloat[\label{fig:cage-fig-2}]{\includegraphics[width=0.85\linewidth]{figures/pair_housed_pic} }\newline
